...
<div class="container mt-5">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-3">
            ...
            <h5>Resi: <?php echo $transaksi['resi_ekspedisi']?></h5>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tfoot>
            <tr>
                ...
                <th><?php echo number_format($transaksi['belanja_transaksi']) ?></t>
            </tr>
            <tr>
                <td colspan="3">Ongkos Kirim</td>
                <th><?php echo number_format($transaksi['ongkir_transaksi']) ?></t>
            </tr>
            <tr>
                <td colspan="3">Total Harus Dibayar</td>
                <th><?php echo number_format($transaksi['total_transaksi']) ?></t>
            </tr>
        </tfoot>
    </table>
            ...
            <div class="col-md-4">
                <table class="table table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo $cekmidtrans['transaction_status'] ?> <br>
...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-apL4WpEQwW1nTfmZ"></script>
