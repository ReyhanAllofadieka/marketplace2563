<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label>Nama</label>
            <input type="text" name="nama_produk" <?php echo $produk['nama_produk'] ?> class="form-control">
        </div>
        <div class="mb-3">
            <label>Harga</label>
            <input type="number" name="harga_produk" <?php echo $produk['harga_produk'] ?> class="form-control">
        </div>
        <div class="mb-3">
            <label>Berat</label>
            <input type="number" name="berat_produk" <?php echo $produk['berat_produk'] ?> class="form-control">
            <span class="text-muted samll">Gram</span>
        </div>
        <div class="mb-3">
            <label>Foto</label>
